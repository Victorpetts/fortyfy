...
const initialState = {
  ...
  usersArr: [
    ...
    },
    {
      ...
      name: "Antonius",
      lvl: "13",
      matchStatistics: [new match(1, 9, 27), new match(2, 7, 1), new match(3, 2, 2), new match(4, 1, 1)],
      checkBox: false,
      friend: true,
      status: "friend",
    ...
    },
    {
      ...
      name: "Petitepinita",
      lvl: "29",
      matchStatistics: [new match(1, 0, 0), new match(2, 1, 0), new match(3, 2, 0), new match(4, 4, 2)],
      checkBox: false,
      friend: true,
      status: "friend",
